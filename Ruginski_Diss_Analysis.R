...
#ref for comparing parameters in lavaan thanks to Terrence Jorgenson https://groups.google.com/d/topic/lavaan/ilvgcEaeR2E/discussion
...
#ref https://statistics.ohlsen-web.de/multiple-imputation-with-mice/. because FIML does listwise deletion with FIML..
set.seed(28)
require(parallel)
...
require(MBESS)
#ref: http://nickmichalak.com/blog_entries/2018/nrg01/nrg01.html
